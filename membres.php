    ...
    <div class="container-fluid flex-grow-1">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3 mt-5 pt-5">
                <!-- Zone centrale -->
                <h1 class="text-center mb-4">La liste des Membres</h1>
                <div>
                ...
                <table class="table table-hover table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        $req = mysqli_query($conn, "SELECT * FROM membre");
                        if (mysqli_num_rows($req) == 0) {
                            echo "<tr><td colspan='7'>Il n'y a pas encore de Membre ajouté !</td></tr>";
                        } else {
