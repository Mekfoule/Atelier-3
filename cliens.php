    ...
    <div class="container-fluid flex-grow-1">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3 mt-5 pt-5">
                ...
                <h1 class="text-center">La liste des cliens</h1>
                <div>
                    <a href="#" class="btn btn-success mb-3 align-items-center">
                        <!-- Icône SVG -->
                    ...
                    <thead>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" background-color="red" fill="currentColor" class="bi bi-trash3 " viewBox="0 0 16 16">
